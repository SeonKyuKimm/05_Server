...
<body>
	...
	<pre>
		...
		6) varStatus : 현재 반복 상태와 관련된 정보를 제공하는 변수선언
			...
			*varStatus 에서 제공되는 값
			...
			- current : 현재 반복 횟수(현재 var의 값) 또는 현재 반복 접근중인 객체(컬렉션 / 배열요소)
						사용시 : vs.current 
						
			- index : 현재 인덱스 값 반환 (0부터 시작)
			
			- count : 현재 몇바퀴째인지 반복횟수를 반환하는 애임( 1부터 시작)		
