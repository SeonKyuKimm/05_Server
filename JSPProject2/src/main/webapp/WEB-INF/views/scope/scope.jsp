...
<body>
	...
	<pre>
		Servlet / JSP 에는 4종류의 범위를 갖는 내장 객체가 존재한다
		...
		3 . session : 현재 사이트에 접속한 브라우저 당 1개씩 생성이되는데,
					  세션스코프가 한번 생성됐다 하면 브라우저가 종료되거나,
					  session 만료될때까지 유효
		
		4 . application : 하나의 웹 어플리케이션마다 1개씩 생성되는 객체
					 	  서버 켜질 때 생성되어, 서버 종료될 때 없어짐
					 	  (서버를 종료하기전까지 유효함)
	</pre>
	...
	<ul>
		<li>
			...
			<% // pagContext : page scope 객체 
				pageContext.setAttribute("pageValue", 5555);
